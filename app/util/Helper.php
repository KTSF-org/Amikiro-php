...
class Helper
{
	...
	/**
	 * Convertie une date obtenue depuis la BDD (2026-04-01 12:00:00) en un String 
	 * compatible avec l'input datetime-local en HTML (2026-06-15T14:30)
	 * @param $input La date à convertir
	 * @return string
	 */
	public static function dateToDatetimelocal(string $input): string
	{
