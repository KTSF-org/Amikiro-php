...
<footer class="footer bg-dark text-light">
  ...
  <div class="container text-center">
    ...
    | <a href="<?= $actual_link ?>confidentialite" target="_blank">Politique de confidentialité</a>
    | <a href="<?= $actual_link ?>mentionslegales" target="_blank">Mentions légales</a>
    | <a href="<?= $actual_link ?>credits" target="_blank">Crédits</a>
  </div>
</footer>
...
<div id="rgpd-banner" class="rgpd-container">
  ...
  <div class="rgpd-buttons">
    <a href="<?= $actual_link ?>confidentialite" class="btn-link">En savoir plus</a>
